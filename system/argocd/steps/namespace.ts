...
`;
    ...
    // kubernetes-bootstrap: platform ArgoCD Applications + charts now live here after merge.
    // Same deploy key — add the public key as a deploy key in kubernetes-bootstrap repo settings.
